...
// v6 — Simplified for the cookie-first activation system.
//
// Why this version is simpler than v5:
//   The page (index.html) now resolves the license key in this strict
//   order: Cookie → URL ?key= → localStorage → sessionStorage, and the
...
//   postMessage. Removing that logic also removes the race condition
//   that caused the old "activation loop" (the page asking the SW for a
//   key before the SW had finished installing/activating).
//
